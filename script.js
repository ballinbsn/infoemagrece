...
/* Dados da empresa / responsável — aparecem no rodapé. */
const COMPANY = {
  name: "Projeto 28 Dias Pro",
  doc: "CNPJ: 67.550.941/0001-70",
  address: "",  // deixe "" para ocultar o endereço; preencha para exibi-lo no rodapé e nas páginas legais
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".js-company-address").forEach((el) => {
    ...
    // Endereço vazio: remove o elemento e limpa separadores/quebras que sobraram antes dele
